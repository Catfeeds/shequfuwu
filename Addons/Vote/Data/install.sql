...
--
-- 表的结构 `waimai_vote_config`
--

CREATE TABLE IF NOT EXISTS `waimai_addon_vote_config` (
...
--
-- 转存表中的数据 `waimai_addon_vote_config`
--

INSERT INTO `waimai_addon_vote_config` (`id`, `name`, `activity_time`, `about`, `vote_num`, `visiter_num`, `time`) VALUES
...
--
-- 表的结构 `waimai_vote_record`
--

CREATE TABLE IF NOT EXISTS `waimai_addon_vote_record` (
`id` int(10) unsigned NOT NULL,
...
--
-- 转存表中的数据 `waimai_vote_record`
--

INSERT INTO `waimai_addon_vote_record` (`id`, `user_id`, `time`) VALUES
...
--
-- Indexes for table `waimai_vote_config`
--
ALTER TABLE `waimai_addon_vote_config`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `waimai_vote_record`
--
ALTER TABLE `waimai_addon_vote_record`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `waimai_vote_config`
--
ALTER TABLE `waimai_addon_vote_config`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `waimai_vote_record`
--
ALTER TABLE `waimai_addon_vote_record`
