...
--
-- 表的结构 `waimai_addon_coupon`
--

CREATE TABLE IF NOT EXISTS `waimai_addon_coupon` (
...
--
-- 表的结构 `waimai_addon_coupon_menu`
--

CREATE TABLE IF NOT EXISTS `waimai_addon_coupon_menu` (
...
--
-- Indexes for table `waimai_addon_coupon`
--
ALTER TABLE `waimai_addon_coupon`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `waimai_addon_coupon_menu`
--
ALTER TABLE `waimai_addon_coupon_menu`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `waimai_addon_coupon`
--
ALTER TABLE `waimai_addon_coupon`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '自增ID';
--
-- AUTO_INCREMENT for table `waimai_addon_coupon_menu`
--
ALTER TABLE `waimai_addon_coupon_menu`
